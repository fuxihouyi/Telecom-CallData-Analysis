...
<div class="All">
    ...
    <script>
        function smonth1(){
            ...
            var i;
            for(var i in ${sessionScope.monthlist}) {
                htmlle += "<a id = '" + ${sessionScope.monthlist}[i].month +"' onclick='one(this)'>"+ ${sessionScope.monthlist}[i].month +" 月</a>";
            }
    ...
    <div class="text-date" style="background-color: rgba(128, 128, 128, 0.5);">
        ...
        color: white;text-shadow: 0 0 7px black;">用户信息</h3>
    ...
    <script>
        ...
        var sumcall = [];
        for (key in data){
            sumcall.push({name:data[key].day+"日",value:data[key].sumcall});
        }
        console.log(sumcall);
        var option = {
            title: {
    ...
    <script>
        ...
        for (key in data){
            sumcall2.push([Math.random()*100,data[key].sumcall,data[key].day+"日"])
        }
